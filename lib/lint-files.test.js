...
test('`lintFilesPkg` call first arg is `CLIEngineOptions` prop of what `this.getMergedConfig` resolves to', async (t) => {
  await t.context.subject.apply(t.context.instance, defaultArgs)
  t.is(t.context.lintFilesPkgMock.args[0][0], (await getMergedConfigRetVal).CLIEngineOptions)
})
