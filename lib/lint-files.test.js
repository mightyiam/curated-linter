...
const defaultArgs = [defaultFiles, defaultOptions]
...
test('if provided, `this.getMergedOpts` first call arg is provided `options`', (t) => {
  t.context.subject.apply(t.context.instance, defaultArgs)
  t.is(t.context.instance.getMergedOpts.args[0][0], defaultOptions)
})
